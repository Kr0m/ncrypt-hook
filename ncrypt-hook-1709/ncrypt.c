...
BOOL WINAPI DllMain(HINSTANCE dll, DWORD reason, LPVOID reserved)
{
	if (reason == DLL_PROCESS_ATTACH)
	{
		...
		p_f_SslGenerateMasterKey = (f_SslGenerateMasterKey)functions[122];
		p_f_SslGenerateSessionKeys = (f_SslGenerateSessionKeys)functions[124];
		p_f_SslImportMasterKey = (f_SslImportMasterKey)functions[130];
	} 
